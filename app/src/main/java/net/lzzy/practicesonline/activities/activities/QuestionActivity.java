    ...
    private void setListeners() {
        pager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                UserCookies.getInstance().getReadCount(questions.get(position).getId().toString());
            }
...
//        pager.setCurrentItem(aId);
    ...
    private void commitPractice() {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("提交",((dialog, which) -> {
                    PracticeResult result =new PracticeResult(results,apiId,"蒙承宇,"+info);
                    postResult(result);
                })).show();
    ...
    private static class ResultHandler extends AbstractStaticHandler<QuestionActivity>{
        ...
        public void handleMessage(Message msg, QuestionActivity activity) {
            ...
            if (msg.what==WIFI_RESPONSE_CODE){
    ...
    private void postResult(PracticeResult result) {
        ...
        AppUtils.getExecutor().execute(()->{
            try {
                ...
                handler.sendMessage(handler.obtainMessage(WIFI_RESPONSE_CODE,code));
