...
public class DetectWebService extends Service {
    ...
    public IBinder onBind(Intent intent) {
        localCount = intent.getIntExtra(PracticesActivity.EXTRA_LOCAL_COUNT,0);//EXTRA_LOCAL_COUNT

        return new DetectWebSerBinder();
    }
    ...
    public class  DetectWebSerBinder extends Binder {
